  ...
  return (
    <>
      <div className="relative w-full h-full bg-gradient-to-br from-secondary to-primary text-center">
        <div className="absolute my-auto grid h-fit right-6 text-white bg-white bg-opacity-30 px-4 py-6 rounded-full space-y-6">
          <FaFacebookF />
          <FaTwitter />
          <FaYoutube />
          <FaGithub />
        ...
        <div className="relative mx-auto w-2/5 space-y-8 py-40 text-center">
          ...
          <p className="text-white text-xl">
            LEMON provides a unique way for Users to create, post & profit from
            their content. Based on other users opinion. Your opinion matters
          </p>
